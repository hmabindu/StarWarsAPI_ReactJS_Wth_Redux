                ...
                <div className="container-fluid bg-3 text-center">
                    ...
                    <div className="row">
                        <div className="col-sm-4">
                            ...
                            <img src="https://s3.amazonaws.com/aws-logs-223602368946-us-east-1/images/Azure_Angel.jpg" className="img-responsive margin" style={{width:100+'%'}} alt="Image"/>
                        </div>
                        <div className="col-sm-4">
                            ...
                            <img src="https://s3.amazonaws.com/aws-logs-223602368946-us-east-1/images/Corellian.jpg" className="img-responsive margin" style={{width:100+'%'}} alt="Image"/>
                        </div>
                        <div className="col-sm-4">
                            ...
                            <img src="https://s3.amazonaws.com/aws-logs-223602368946-us-east-1/images/HWK290-XWMG.png" className="img-responsive margin" style={{width:100+'%'}} alt="Image"/>
                        </div>
                    </div>
                </div>
            </div>
